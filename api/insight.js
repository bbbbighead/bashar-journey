...
- message：350–550字、分 3–4 段的正式綜合內容——核心狀態（兩源收斂）→ 正在醞釀什麼／阻力或盲點在哪／時機與節奏 → 結尾給「視角、心境或策略層次」的啟發（一個值得換上的觀點、一種面對的姿態、或一條思考的策略）。**結尾嚴禁開立具體的生活行動處方**：不得指示去做某個實體動作、不得要求找特定的人、對外宣告、購買或執行清單——把「怎麼做」留給他自己。
- closing：一句臨別祝福（≤40字）。`;
    default:
      return '';
  }
